...
tekstas1=Text(savaitės_langas, width=15, height=10)
tekstas1.place(x=10, y=110)
...
tekstas2=Text(savaitės_langas, width=15, height=10)
tekstas2.place(x=160, y=110)
...
tekstas3=Text(savaitės_langas, width=15, height=10)
tekstas3.place(x=310, y=110)
...
tekstas4=Text(savaitės_langas, width=15, height=10)
tekstas4.place(x=460, y=110)
...
tekstas5=Text(savaitės_langas, width=15, height=10)
tekstas5.place(x=610, y=110)
...
tekstas6=Text(savaitės_langas, width=15, height=10)
tekstas6.place(x=760, y=110)
...
tekstas7=Text(savaitės_langas, width=15, height=10)
tekstas7.place(x=910, y=110)
...
file_menu.add_command(label='Trinti', command=trinti_langas)
